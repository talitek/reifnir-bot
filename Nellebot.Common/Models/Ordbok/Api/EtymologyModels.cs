...
{
    [JsonPropertyName("items")] public List<EtymologyLanguageElement> EtymologyLanguageElements { get; set; } = new();
}
...
{
    [JsonPropertyName("items")] public List<EtymologyReferenceElement> EtymologyReferenceElements { get; set; } = new();
}
...
public record EtymologyReferenceArticleRef : EtymologyReferenceElement
{
    ...
    [JsonPropertyName("definition_id")] public int? DefinitionId { get; set; }
...
{
    [JsonPropertyName("items")] public List<EtymologyLittElement> EtymologyLittElements { get; set; } = new();
}
